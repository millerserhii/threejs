...
for (let i = 0; i < 50; i++) {
    ...
    const radius = Math.random() * 6 + 3.75
...
const tick = () => {
    ...
    ghost1.position.y = Math.sin(elapsedTime * 0.03)

    const ghost2Angle = - elapsedTime * 0.1
    ghost2.position.x = Math.cos(ghost2Angle) * 5
    ghost2.position.z = Math.sin(ghost2Angle) * 5
    ghost2.position.y = Math.sin(elapsedTime * 0.04)
    ...
    ghost3.position.y = Math.sin(elapsedTime * 0.05)
