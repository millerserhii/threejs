...
const generateGalaxy = () => {
    ...
    for (let i = 0; i < parameters.count; i++) {
        ...
        // position
        const radius = Math.pow(Math.random(), parameters.powerRadius) * parameters.radius
...
gui.add(parameters, 'size', 0.01, 0.1, 0.001).onFinishChange(generateGalaxy)
...
gui.add(parameters, 'powerRadius', 1, 10, 0.001).onFinishChange(generateGalaxy)
